<?php 
 ...
 $limit = 2;
  ...
  {
    $search = $_GET['search'];
    $sql_page = "select * from `post` where titel like '%$search%'  limit $start , $limit";
    $total_rec = "select * from `post` where titel like '%$search%' ";

  }
  else {
    $sql_page = "select * from `post` limit $start , $limit";
    $total_rec = "select * from `post`";
...
?>
                    <tr>
                      ...
                      <td><img style="width:'100px'" src="../image/latest_posts/<?php echo @$data['image'];?>" width="100px"height="50px"> </td>
...
?>
                      ...
                      <td><a href="add_post.php?id=<?php echo @$data['id']; ?>">Edit</a> </td>
